...
% 2019 cell tracking challenge. Every file runs the tracking on a single
...
% RunBaxterAlgorithms_ISBI_2019 using the command matlab -r. -wait is added
...
%
% See also:
% RunBaxterAlgorithms_ISBI_2019, BaxterAlgorithmsTerminal, BaxterAlgorithms
