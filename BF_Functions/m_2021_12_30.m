...
exportdir='D:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Isa\2021-10-02-BigPRoteinScreen\2021-12-31-TestMultiTimepoint';
filetype='tif';
...
%Nuclear Stain
        ...
        NucLow=150;%Choose number 0-20, start at 0. Higher numbers remove more dim cells and background.
     %Cytosol    
        CytMax= 1; %Number 0-1, removes Cell Debris brighter than this value. 0.2 is usually a good start  
...
%     T_Value = reader.getSizeT();
            ...
            Nuc = bitConvert*bfGetPlane(reader,iplane+1);

            cyt = bitConvert*bfGetPlane(reader,iplane+2);

            drug = bitConvert*bfGetPlane(reader,iplane+3);
