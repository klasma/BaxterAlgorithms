...
clc, clear, close all
reader = bfGetReader(char("Z:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Brock Fletcher\2021-09-08\DoseResponse\Gal8\BF_Gal8Overnight_Test003.nd2"));
exportdir=char('D:\Dropbox (VU Basic Sciences)\Duvall Confocal\Duvall Lab\Brock Fletcher\2021-09-08\DoseResponse\Gal8\Analysis\Test');
...
Img=zeros(2048,6104,numPlanes,T_Value+1);
for i=0:T_Value
