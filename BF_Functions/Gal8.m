function [GalPals,Gal8Signal,Gal_bw_Perim] = Gal8(Img,Gal8MinThreshold,CytPos,MiPerPix)
...
Ring=regionprops(Gal_bw_Perim,Img,'Area','Centroid','MeanIntensity'); %need to figure out way to subtract out surrounding brightness for each individual Point
