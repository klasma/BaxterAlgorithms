...
%                                 Nuc=AnaImage;
                        ...
                        case 'Nuc_Cyt'
                               [NucLabel,Nuc_bw4,NucPos,NucBrightEnough,NucMT1,NucOpen,Nuc_eq,NucTopHat,Nuc_bw4_perim,NucOverbright,NucQuant1,NucWeiner,NucArea] = Nuc_Cyt(AnaImage,AnaSettings{1},AnaSettings{2},CytTopHat,cyt_bw4,MiPerPix);
%                                Ratio
%                                imshow(imadjust(Nuc))
                            if ~isempty(ImageAnalyses{k,:}{4})
                                    RGBExportImage(:,:,ImageAnalyses{k,:}{4}{1})=Img_eq;
