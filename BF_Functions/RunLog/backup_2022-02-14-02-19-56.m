...
%Input Planes
    ...
    ImageAnalyses=    {
                        ...
                        {{'NucSimple_MinusCyt'},{3 1},{0.6 1400},{3},{'Nuc_bw4_perim' [0.8500 0.3250 0.0980]}};
            ...
            for k=1:length(ImageAnalyses)
                    ...
                    switch Analysis
                        ...
                        case 'NucSimple_MinusCyt'
                               [NucLabel,Nuc_bw4,NucPos,NucBrightEnough,NucOpen,Nuc_eq,NucTopHat,Nuc_bw4_perim,NucOverbright,NucWeiner,NucArea] = NucSimple_MinusCyt(AnaImage,AnaSettings{2},AnaSettings{1},MiPerPix,cyt_bw4,Cyt)                            
                            if ~isempty(ImageAnalyses{k,:}{4})
                                    RGBExportImage(:,:,ImageAnalyses{k,:}{4}{1})=Img_eq;
                                end      
