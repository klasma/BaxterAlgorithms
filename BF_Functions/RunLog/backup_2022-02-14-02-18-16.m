            ...
            for k=1:length(ImageAnalyses)
                    ...
                    switch Analysis
                        ...
                        case 'NucSimple_MinusCyt'
                               [NucLabel,Nuc_bw4,NucPos,NucBrightEnough,NucOpen,Nuc_eq,NucTopHat,Nuc_bw4_perim,NucOverbright,NucWeiner,NucArea] = NucSimple_MinusCyt(Img,Low,Max,MiPerPix,cyt_bw4,Cyt)                            
                            if ~isempty(ImageAnalyses{k,:}{4})
                                    RGBExportImage(:,:,ImageAnalyses{k,:}{4}{1})=Img_eq;
                                end      
