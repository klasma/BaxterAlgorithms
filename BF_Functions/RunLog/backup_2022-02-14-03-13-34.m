...
%Input Planes
    ...
    ImageAnalyses=    {
%                         {{'Nuc'},{3 1},{0.6 1400},{3},{}};
                        {{'Cyt'},{1},{0.8 100},{2},{'cyt_bw4_perim' [0.4940, 0.1840, 0.5560]}};
                         {{'Nuc_Cyt'},{3 1},{0.6 1400},{3},{'Nuc_bw4_perim' [0.8500 0.3250 0.0980]}};
...
%                                 Nuc=AnaImage;
                        ...
                        case 'NucSimple_MinusCyt'
                               [NucLabel,Nuc_bw4,NucPos,NucBrightEnough,NucOpen,Nuc_eq,NucTopHat,Nuc_bw4_perim,NucOverbright,NucWeiner,NucArea] = NucSimple_MinusCyt(AnaImage,AnaSettings{2},AnaSettings{1},MiPerPix,cyt_bw4,Cyt,AnaSettings{3});                            
                            if ~isempty(ImageAnalyses{k,:}{4})
                                    RGBExportImage(:,:,ImageAnalyses{k,:}{4}{1})=Img_eq;
                                end      
                        case 'Nuc_Cyt'
                               [NucLabel,Nuc_bw4,NucPos,NucBrightEnough,NucMT1,NucOpen,Nuc_eq,NucTopHat,Nuc_bw4_perim,NucOverbright,NucQuant1,NucWeiner,NucArea] = Nuc_Cyt(AnaImage,AnaSettings{2},AnaSettings{1},CytTopHat,cyt_bw4,MiPerPix)
%                                Ratio
%                                imshow(imadjust(Nuc))
                            if ~isempty(ImageAnalyses{k,:}{4})
                                    RGBExportImage(:,:,ImageAnalyses{k,:}{4}{1})=Img_eq;
