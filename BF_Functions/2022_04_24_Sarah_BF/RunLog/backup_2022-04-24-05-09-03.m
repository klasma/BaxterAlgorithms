...
parfor j=ParSplit+nn-2% Number of wells in ND2 File  
...
%                         DataLoop=strcat(DataName{k},'_',num2str(k));
    ...
    %% Get Area and Intensities
       [AllData2,ExportParamNames] = LabelAnalysis(LiveData,Img2,Well,Timepoint,AllData2,ExportParamNames);
