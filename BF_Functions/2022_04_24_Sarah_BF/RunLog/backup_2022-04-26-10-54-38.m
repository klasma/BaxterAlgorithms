...
%         AllData4{nn}=AllData3;
            AllData4{nn,j+1,i+1}=AllData3; %Store Data in parfor-compatible way
    end %end of all analysis
%     TidyFeat
    
%% Write Analysis Data to File    
[TPs] = CumCell(ParWell); %Custom Function to combine weird data format from parfor Loop
