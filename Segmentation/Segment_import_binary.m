function oBw = Segment_import_binary(aImData, aFrame)
% Imports a segmentation which has been saved as 16-bit tif label images.
%
% This function returns only a binary segmentation mask, so adjacent
% regions will be merged in the subsequent segmentation. The function works
% for both 2D and 3D data. For 3D data, the 3D settings from the microscopy
% image sequence are used.
%
