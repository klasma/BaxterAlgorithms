    ...
    methods
        function this = SEGOptimizerSeq(aSeqPath, aSettings, varargin)
            ...
            [...
                ...
                {nan, false, 'SEG', cell(size(aSettings)), false, true, [], [], '_GT'},...
                true,...
                varargin);
            ...
            try
                ...
                switch this.scoringFunction
                    ...
                    case '0.45*SEG1+0.45*SEG2+0.1*DET'
                        SEG2 = PerformanceSEG(this.seqPath, verName, true,...
                            'Suffix', this.suffix2,...
                            'ResFilename', sprintf('SEGR_%s_log.txt', this.suffix2));
                        DET = PerformanceDET(this.seqPath, verName,...
                            'Suffix', this.suffix);
                        oF = 1 - (0.45 * SEG + 0.45 * SEG2 + 0.1 * DET);
                    case '(SEG+TRA)/2'
