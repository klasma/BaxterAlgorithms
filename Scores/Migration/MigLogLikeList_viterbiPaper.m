function oList = MigLogLikeList_viterbiPaper(aBlobSeq, aImData, aMaxArcs)
% Compute migration scores as described in [1].
%
% The function computes the log likelihood of possible migrations between
...
for t = 1:length(aBlobSeq)-1
    ...
    log_pos = log(aImData.Get('TrackPMig')) + log_f_pos;
    log_neg = log(1-aImData.Get('TrackPMig')) + log_f_neg;
